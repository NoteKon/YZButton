...
#    ss.vendored_frameworks = 'YZButton/Frameworks/**/*.framework'
#    ss.vendored_libraries = 'YZButton/Frameworks/**/*.a'
#    # 远程第三方库
...
#    ss.resource_bundles = {
#      'YZButton' => [
#           'YZButton/Assets/YZButton.xcassets',
#           'YZButton/Assets/OtherResources/**/*.{storyboard,xib,xcassets,lproj,plist,json}'
#       ]
#    }
#  end
  ...
  s.subspec "File" do |ss|
    ss.source_files = 'YZButton/Classes/**/*'
#    ss.dependency 'YZButton/Resources'
#    ss.dependency 'YZButton/Dependency'
  end
  
  # Framework包依赖, 使用打包脚本打包后可用
  s.subspec "Framework" do |ss|
    ss.vendored_frameworks = 'YZButton.xcframework'
#    ss.dependency 'YZButton/Dependency'
