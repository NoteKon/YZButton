...
//  test
//
//  Created by ice on 2021/10/25.
//  Copyright © 2021 ice. All rights reserved.
//

import UIKit
import Foundation
public class YZButton: UIControl {
    /// 布局类型 (同时有标题和图片的时候生效)
    public enum Layout {
        /// 标题在左
        case titleLeft
    ...
    /// 标题
    public lazy var titleLabel = ButtonLabel()
    
    /// 图片
    public lazy var imageView = ButtonImageView()
...
public class ButtonLabel: UILabel {
...
public class ButtonImageView: UIImageView {
